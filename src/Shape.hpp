...
public:
	...
	void scale_change(GLfloat x);	// to change the scale factor
	 ...
	 void rotate_mc(GLfloat rx, GLfloat ry, GLfloat rz, GLfloat angle); // to rotate the MC with respect to a local axis.
	 void rotate(GLfloat rx, GLfloat ry, GLfloat rz, GLfloat angle);// to rotate the MC including both vectors and origin
